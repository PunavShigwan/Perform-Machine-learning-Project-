...
with col1:
    ...
    # ----------------------
    # Camera preview + Start Button (no time constraints)
    # ----------------------
    if source is not None:
        ...
        # Live preview until 'Start' is clicked
        if not start_button:
            while cap.isOpened():
                ret, frame = cap.read()
                if not ret:
            ...
            st.markdown("### 🧠 Pushup Classification Running...")
            ...
            while cap.isOpened():
                ...
                if landmarks:
                    ...
                    if state == "UP" and label == 0:
                        ...
                        predicted_max = max(5, predicted_max + int((score - 70) / 20))
